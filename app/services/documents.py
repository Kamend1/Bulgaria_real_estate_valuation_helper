...
_GENERIC_EXTRACTION_HINTS = {
    ...
    "site_photo": "Опиши накратко какво се вижда на снимката (част от имота, състояние, забележими детайли) -- само наблюдаемото, без предположения.",
